...
begin
        @__doc__ struct OLTC <: AbstractLine
                ...
                Pvl
                iLeer
                OLTC(; from, to, Uos, Uus, k, ssp, stufe_us, Sr, uk, Pvk, Pvl, iLeer) = new(from, to, Uos, Uus, k, ssp, stufe_us, Sr, uk, Pvk, Pvl, iLeer)
            end
...
PiModel(o::OLTC) = OLTC_Y(o.Uos, o.Uus, o.k, o.ssp, o.stufe_us, o.Sr, o.uk, o.Pvk, o.Pvl, o.iLeer)
